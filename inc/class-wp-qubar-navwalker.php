<?php
/**
 *empath Bootstrap Navwalker
 *
 * @packageempath-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Qubar_Bootstrap_Navwalker' ) ) {
	/**
	 * Qubar_Bootstrap_Navwalker class.
	 */
	class Qubar_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'forcast' ) . '">' . esc_html__( 'Add a menu', 'forcast' ) . '</a></li>';
			$fallback_output .= '</ul>';
